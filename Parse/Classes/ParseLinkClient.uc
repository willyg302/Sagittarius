 ...
 */
class ParseLinkClient extends TcpLink;

var string NEWLINE;

var string ServerURL;
var int ServerVersion;

/* The only class that this link client actually communicates with. In this way
 * Parse.uc serves as a middleman and "masks" this class.
 */
var Parse Parent;
...
function Initialize(Parse p, string THost)
{
	Parent = p;
	ServerURL = "api.parse.com";
	ServerVersion = 1;
